define({ "api": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "from",
            "description": "<p>tanggal mulai format 'yyyy-mm-dd'.</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "to",
            "description": "<p>tanggal akhir format 'yyyy-mm-dd'.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    "type": "get",
    "url": "/transaksis/type",
    "title": "Lihat Transaksi By Type",
    "name": "LihatTransaksiByType",
    "group": "Transaksi",
    "permission": [
      {
        "name": "admin",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "name",
            "description": "<p>nama jenis transaksi (debit/credit).</p>"
          }
        ]
      }
    },
